...
class Labelme2YOLO(object):
        ...
        for file_name in os.listdir(json_dir):
            if file_name.endswith('json'):
                ...
                for shape in data['shapes']:
                    label_item = shape['label']
                    label_set.add(label_item)
        print('overwirte label id map')
        label_id_map = OrderedDict([])
        label_id_map['微信'] = 0
        label_id_map['QQ'] = 1
        label_id_map['元梦LOGO'] = 2
        label_id_map['元梦之星logo'] = 2
        label_id_map['元梦logo'] = 2
        label_id_map['logo'] = 3
        return label_id_map
        ...
        for target_dir, json_names in zip(('train/', 'val/'),
            ...
            for json_name in json_names:
                try:
                    ...
                    print(f'unknown error for:{img_path}')
                    print(e)
    ...
    def _save_yolo_image(self, json_data, json_name, image_dir_path, target_dir):
        ...
        img_path = os.path.join(image_dir_path, target_dir, json_name.split('.')[0] + f'.{img_format}')
    ...
    def _save_dataset_yaml(self):
        ...
        with open(yaml_path, 'w+', encoding='gbk') as yaml_file:
