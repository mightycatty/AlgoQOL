...
def main(json_file: str = r'/mnt/juicefs/cv_tikv/heshuai/datasets/openbrand/openbrand.json',
         output: str = r'/mnt/juicefs/cv_tikv/heshuai/datasets/openbrand/labels',
         output_set='train',
         val_num=0):
