...
parser.add_argument("-name", "--searchWord", required=False, default='cat')
parser.add_argument("-count", "--wantCount", default=100)
...
async def PrintAll(i, driver, json_data):
    ...
    try:
        ...
        return
    try:
        request = Request(attr_src, headers={
